...
exports.target = {
    create: function (o) {
        return sql('insert_target',
            'INSERT INTO target (name, category, description, created, updated) VALUES ($1, $2, $3, $4, $5) RETURNING id',
            [o.name, o.category, o.description, new Date(), new Date()] );
    }
}
...
exports.blip = {
    create: function (o) {
        return sql('insert_blip',
            'INSERT INTO blip (target_id, radar_id, distance, comment, created, updated) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id',
