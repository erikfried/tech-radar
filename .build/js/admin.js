...
React.render(React.createElement(Radar, null),
...
},{"./foo":151,"./radar":152,"react":149}],151:[function(require,module,exports){
            ...
            React.createElement("div", {className: "radar"}, 
                React.createElement("div", {className: "svg-container"}, 
                    React.createElement("svg", {id: "svg-area", viewBox: "0 0 450 450", preserveAspectRatio: "xMinYMin meet", 
                        ...
                        React.createElement(Blips, {data: blips}), 
                        React.createElement("text", {x: "400", y: "30"}, "Tools"), 
                        React.createElement("text", {x: "0", y: "30"}, "Techniques"), 
                        React.createElement("text", {x: "0", y: "435"}, "Platforms"), 
                        React.createElement("text", {x: "290", y: "435"}, "Languages & Frameworks")
                    )
                ), 
...
},{"../../lib/shared/angleCalculator":1,"../../lib/shared/constants":2,"./radarList":153,"react":149}],153:[function(require,module,exports){
var React = require('react');
/**
 * @jsx React.DOM
 */
...
var Blip = React.createClass({displayName: 'Blip',
    getInitialState: function () {
        return {active: false};
    },
    setActive: function () {
    ...
    render: function () {
        ...
        return (
            React.createElement("g", {className: className, 
                'data-target': this.props.name, 
                onMouseOver: this.setActive, 
                onMouseOut: this.setInactive}, 
                React.createElement("circle", {className: "blipMarker", cx: this.props.coords.x, cy: this.props.coords.y, r: "5"}), 
                React.createElement("text", {className: "blipNumber", x: text.x, y: text.y}, this.props.name)
            )
        );
    }
});
var Blips = React.createClass({displayName: 'Blips',
    render: function() {
        var markers = this.props.data.map(function (blipdata) {
            ...
            return React.createElement(Blip, {coords: blipdata.coords, name: blipdata.name})
        })
        return (
   ...
   render: function () {
       ...
       var listItems = function (list) {
           return list.map(function (item) {
               return (
                   React.createElement("li", {className: "list-group-item item", 'data-target': item.name}, 
...
var RadarListItem = React.createClass({displayName: 'RadarListItem',
    getInitialState: function () {
        return {active: false};
    },
    setActive: function () {
    ...
    render: function () {
        ...
        return (
            React.createElement("li", {className: className}, item.name, " onMouseOver=", this.setActive, " onMouseOut=", this.setInactive, 
                React.createElement("span", {className: "description"}, item.description), 
                React.createElement("span", {className: "comment"}, item.comment)
            )
        );
...
var StatusList = React.createClass({displayName: 'StatusList',
   render: function () {
       ...
       var listItems = function (list) {
           return list.map(function (item) {
               return React.createElement(RadarListItem, {item: item});
           });
       }
       var statusList = Object.keys(self.props.data).map(function (status) {
           var _listItems = listItems(self.props.data[status]);
